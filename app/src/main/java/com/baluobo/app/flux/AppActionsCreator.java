...
import static com.baluobo.user.model.SendVerifyCodeType.SEND_VERIFY_CODE_TYPE_CHANGE_MOBILE;
import static com.baluobo.user.model.SendVerifyCodeType.SEND_VERIFY_CODE_TYPE_LOGIN;
import static com.baluobo.user.model.SendVerifyCodeType.SEND_VERIFY_CODE_TYPE_REGISTER;
...
public class AppActionsCreator extends ActionsCreator {
     ...
     * @param phone 手机号
     */
    public void sendCheckCode(String phone, String type){
        String md5 = Util.MD5(phone + type + AppConfig.deviceType + AppConfig.verfiyCode);
        dispatcher.dispatch(new RegisterAction(RegisterAction.ACTION_REQUEST_START));
        apiService.sendCheckCode(phone, type, md5, AppConfig.deviceType).enqueue(new Callback<BaseModel>() {
            @Override
    ...
    public void sendLoginCheckCode(String phone){
        String type = SEND_VERIFY_CODE_TYPE_LOGIN.getType();
        String md5 = Util.MD5(phone + type + AppConfig.deviceType + AppConfig.verfiyCode);
    ...
    public void changeMobileSendCheckCode(String phone){
        String type = SEND_VERIFY_CODE_TYPE_CHANGE_MOBILE.getType();
        String md5 = Util.MD5(phone + type + AppConfig.deviceType + AppConfig.verfiyCode);
...
//                }
    ...
    public void sendFastRegisterCheckCode(String phone){
        String type = SEND_VERIFY_CODE_TYPE_REGISTER.getType();
        String md5 = Util.MD5(phone + type + AppConfig.deviceType + AppConfig.verfiyCode);
