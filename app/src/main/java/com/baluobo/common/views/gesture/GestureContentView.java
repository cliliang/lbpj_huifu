...
public class GestureContentView extends ViewGroup {
    ...
    public GestureContentView(Context context, boolean isVerify, String passWord, GestureCallBack callBack) {
        super(context);
        viewBlock = getResources().getDimensionPixelSize(R.dimen.guide_text_margin_bottom);
        screenDispaly = UIHelper.getScreenDisplay(context);
        blockWidth = (screenDispaly[0] - viewBlock) / 3;
    ...
    public void setParentView(ViewGroup parent) {
        int width = screenDispaly[0] - viewBlock;
