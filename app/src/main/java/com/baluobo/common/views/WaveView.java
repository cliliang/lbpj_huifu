...
public class WaveView extends View {
    ...
    private static final float DEFAULT_WAVE_LENGTH_RATIO = 1f;
    private static final float DEFAULT_WAVE_SHIFT_RATIO = 0.0f;

    public static final int DEFAULT_BEHIND_WAVE_COLOR = Color.TRANSPARENT;
    public static final int DEFAULT_FRONT_WAVE_COLOR = Color.parseColor("#ff6e54");
