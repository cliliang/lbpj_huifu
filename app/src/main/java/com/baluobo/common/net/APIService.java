...
public interface APIService {
     ...
     * 发送手机验证码
     * @param mobile 手机号
     * @param type 登录0 注册1 修改手机号2 修改密码3
     */
    @FormUrlEncoded()
    @POST(APIClient.sendPhoneCode)
    Call<BaseModel> sendCheckCode(@Field("mobile") String mobile, @Field("type")String type, @Field("encryptKey")String encryptKey, @Field("deviceType")String deviceType);
